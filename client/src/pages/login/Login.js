    ...
    <section class="h-screen">
        <div class="px-6 h-full text-gray-800">
          ...
          >
            ...
            >
              <img
                src={loginImage} class="w-full" alt="Sample" />
            </div>
              ...
              <form onSubmit={handleSubmit}>
                <div class="flex flex-row items-center justify-center lg:justify-start">
                  ...
                  <button
                    ...
                    class="inline-block p-3 bg-orange-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-orange-700 hover:shadow-lg focus:bg-orange-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-orange-800 active:shadow-lg transition duration-150 ease-in-out mx-1"
                  >
                    {/* <!-- Facebook --> */}
                ...
                {/* name input filed  */}
                {registerActive && <div class="mb-6">
                  <input
                    type="text"
                    class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-orange-600 focus:outline-none focus:ring-0"
              ...
              gender selection  */}
                ...
                <div class="text-center lg:text-left">
                  ...
                  <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                    ...
                    <span
                      href="#!"
                      class="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out cursor-pointer" onClick={handleRegisterActive}
