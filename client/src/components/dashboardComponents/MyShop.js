        ...
        <div>
            <div className=" p-5 rounded bg-white">
                <div className="flex items-center justify-center">
                    <div className="">
                        <img className="w-16 h-16 border-solid border-gray-200 border-4 rounded-full" src={`http://localhost:8000/uploads/${shop?.profilePicture}`} alt=""/>
                        <span className="text-gray-700 text-center text-2xl">{shop?.name}</span>
