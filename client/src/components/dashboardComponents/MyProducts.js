...
export default function MyProducts(){
    ...
    if(isLoading){
        ...
        content = products.map((product)=> (
            <tr class="border-b border-orange-200 hover:bg-orange-100">
                <td class="py-3 px-6 text-left whitespace-nowrap">
                    <div class="flex items-center">
                        <div class="mr-2">
                        <img class="w-6 h-6 rounded-full" src={`http://localhost:8000/uploads/${product?.thumbnail}`} alt=""/>
                        </div>
                ...
                <td class="py-3 px-6 text-center">
                    <span class="text-base font-semibold">{product?.purchasePrice}</span>
                </td>
                <td class="py-3 px-6 text-center">
                    <span class="text-base font-semibold">{product?.retailPrice}</span>
                </td>
                <td class="py-3 px-6 text-center">
                            ...
                            <div class="w-full ">
                                <div class="bg-white shadow-md rounded my-6">
                                    <table class="min-w-max w-full table-auto">
                                        <thead>
                                            <tr class="bg-orange-200 text-orange-600 text-sm leading-normal">
                                                <th class="py-3 px-6 text-left">Product</th>
                                                <th class="py-3 px-6 text-left">Category</th>
                                                <th class="py-3 px-6 text-center">In Stock</th>
                                                <th class="py-3 px-6 text-center">Cost Price</th>
                                                <th class="py-3 px-6 text-center">MRP</th>
